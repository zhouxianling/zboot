package com.zxl.sb.common.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ErrorResponse customExceptionHandler(HttpServletRequest request, final Exception e, HttpServletResponse response) {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
        ...
        if (ex instanceof MethodArgumentTypeMismatchException) {
            ...
            return new ResponseEntity<>(new ErrorResponse(status.value(), "参数不正确"), status);
        }
        return new ResponseEntity<>(new ErrorResponse(status.value(), "参数不正确"), status);
    }
}
